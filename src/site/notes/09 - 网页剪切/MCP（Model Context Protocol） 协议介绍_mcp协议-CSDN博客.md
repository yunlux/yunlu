...
模型上下文协议 (MCP) 是一种开放协议，可实现 LLM 应用程序与外部[数据源](https://so.csdn.net/so/search?q=%E6%95%B0%E6%8D%AE%E6%BA%90&spm=1001.2101.3001.7020)和工具之间的无缝集成，无论是构建智能 IDE、扩展接口，还是创建 AI 工作流程，MCP 都提供了一种标准化方法，将 LLMs 与其所需的上下文连接起来。  
如上图所示，其中每个节点的作用如下：
