...
当然，如果这是一张网页，我反而会觉得这么粗很漂亮。

可这么小的笔记本，默认字这么小，看上去就显得太粗了。

---

3，笔记名称后面的尾巴如何去掉？

当然，去掉的同时保留Markdown渲染功能。

如果能选择，希望我新建的笔记都是Markdown渲染的。
...
[foo](http://example.com/ "Optional Title Here"): [http://example.com/](http://example.com/) 'Optional Title Here'  
...
Visit [Daring Fireball](http://daringfireball.net/) for more information.
